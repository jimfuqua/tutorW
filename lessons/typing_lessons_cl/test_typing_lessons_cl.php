...
/**
 * @file Test lesson typing_lessons_cl.php.
 *
 ...
 * and then running typing_lessons_cl.php.
 *
 * PHP version 5
 *
...
$class_instance ->delRowsByStudentIdAndAssignmentName($_SESSION['tA_S_ID'], 'gA_typing_lessons_cl');
