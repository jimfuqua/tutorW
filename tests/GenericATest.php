<?php
include_once '/var/www/jimfuqua/tutor/src/classes/GenericAClass.inc';
...
//$logFile = fopen("/var/www/tutor/logs/php_log.log", "w");
//$string = "\$result=".$result."  line 81"."\n";
...
class GenericATest extends PHPUnit_Framework_TestCase {
    ...
    */
    ...
    {
        //$logFile = fopen("/var/www/tutor/logs/compareClassMethodsToTests.log", "w");
        ...
        $class_methods = get_class_methods(new classes\GenericAClass());
...
//     }
    ...
    */
    public function testeditRow()
    {
        ...
        $logFile = fopen("/var/www/jimfuqua/tutor/logs/testeditRow", "w");
